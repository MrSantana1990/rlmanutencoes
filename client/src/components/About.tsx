        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <SafeImage
              ...
              alt={`Equipe ${SITE_CONFIG.companyName}`}
              className="w-full rounded-lg shadow-lg"
              fallbackLabel={`Equipe ${SITE_CONFIG.companyName}`}
            />
          </div>

          {/* Right: Content */}
          <div className="order-1 lg:order-2">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Sobre a {SITE_CONFIG.companyName}</h2>
            <p className="text-lg text-foreground mb-8 leading-relaxed">
              Atuamos com manutenção industrial integrada para reduzir paradas, aumentar previsibilidade e manter a operação segura — do diagnóstico à execução.
            </p>
